                    ...
                    <?php
                        if (isset($_SESSION['user'])){
                            ...
                            <form action="../components/shoppingCart.php" method="post">
                                ...
                                <input class="btn btn-block bg-dark text-success mt-2" type="submit" value="Add To Cart">
                            </form>
                            <form action="details.php?id='.$productInfo["product_id"].'" method="post">
                                ...
                                <button class="btn btn-block bg-dark text-warning mt-2 ml-2" name="wish"><i class="fa fa-heart-o text-warning" aria-hidden="true"></i> Wishlist</button>
                                
                            </form>
                       ';}
                         if ( isset($_SESSION['admin']) || isset($_SESSION['superAdmin']) ) {
                            echo '<a class="btn btn-dark text-warning mr-2" href="update.php?id='.$productInfo["product_id"].'">Edit</a>
                              <button class="btn btn-dark text-danger delBtn" data-href="delete.php?id='.$productInfo["product_id"].'">Delete</button>';
                        }
                    ?> 
                </div>
            </div>
